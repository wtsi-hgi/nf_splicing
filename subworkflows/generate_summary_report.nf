...
process CREATE_HTML_REPORT {
    ...
    memory {
        ...
        def mem = file_size_total <= 100_000_000 ? 3 :
                  file_size_total <= 1_000_000_000 ? 6 :
                  file_size_total <= 2_000_000_000 ? 12 :
                  file_size_total <= 4_000_000_000 ? 24 : 
                  file_size_total <= 8_000_000_000 ? 48 : 96
        "${mem * task.attempt} GB"
    }
