...
if __name__ == "__main__":
    ...
    parser.add_argument("--variant_up",       type = str.upper, required = True,       help = "Upstream flank sequence of variant in read1")
    parser.add_argument("--variant_down",     type = str.upper, required = True,       help = "Downstream flank sequence of variant in read1")
    ...
    parser.add_argument("--barcode_up",       type = str.upper, required = True,       help = "Upstream flank sequence of barcode in read2")
    parser.add_argument("--barcode_down",     type = str.upper, required = True,       help = "Downstream flank sequence of barcode in read2")
    parser.add_argument("--barcode_check",    action="store_true",                     help = "Enable barcode checking against template")
    parser.add_argument("--barcode_temp",     type = str.upper,                        help = "Template for barcode sequence (e.g., 'NNATNNNNATNNNNATNNNN')")
