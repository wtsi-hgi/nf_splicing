...
cat("                                         .groups = \"drop\")", "\n", sep = "")
cat("boxplot_min <- min(unlist(junction_category_reshape$CovAvg_log), na.rm = TRUE)", "\n", sep = "")
cat("boxplot_max <- max(unlist(junction_category_reshape$CovAvg_log), na.rm = TRUE)", "\n", sep = "")
cat("reactable(junction_category_reshape, highlight = TRUE, bordered = TRUE, striped = TRUE, compact = TRUE, wrap = TRUE,", "\n", sep = "")
